...
if __name__ == '__main__':
    ...
    dataset_map = {
        'AP_QQPairs': QQPairsH5Processor
    }

    # tell the CLI user that they mistyped the data set
    args.dataset = 'AP_QQPairs'
