...
from data.h5_processors.rte_H5_processor import RTEH5Processor
from utils.compress_utils import DetectParts, DP_Model
...
if __name__ == '__main__':
    ...
    model = DP_Model(layers=13, batch_sz=args.batch_size, tokens=512, features=768, labels=2).to(device)
