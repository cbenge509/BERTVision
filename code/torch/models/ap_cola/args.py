...
def get_args():
    ...
    # set some AP_COLA specific args
    parser.add_argument('--model', default=None, type=str, required=True)
    parser.add_argument('--device', default=device)
    parser.add_argument('--dataset', type=str, default='COLAH5', choices=['COLAH5'])
    parser.add_argument('--model-name', default='ap_cola', type=str)
