...
from common.evaluators.bert_class_evaluator_cb import BertClassEvaluator
...
class BertClassTrainer(object):
    ...
    def train_epoch(self, train_dataloader):
        ...
        for step, batch in enumerate(tqdm(train_dataloader, desc="Training")):
            ...
            #print(loss.item(), self.tr_loss, self.nb_tr_steps)
    ...
    def train(self):
        ...
        for epoch in trange(int(self.args.epochs), desc="Epoch"):
            ...
            metric, pr, sr = BertClassEvaluator(self.model, self.processor, self.args).get_loss()
            log['metric'].append(metric)
            log['pearsonr'].append(pr)
            log['spearmanr'].append(sr)
            ...
            if metric > self.metric:
                ...
                if self.unimproved_iters >= self.args.patience:
                    ...
                    tqdm.write("Early Stopping. Epoch: {}, Best RMSE: {}".format(epoch, self.metric))
                    break
        print(log)
